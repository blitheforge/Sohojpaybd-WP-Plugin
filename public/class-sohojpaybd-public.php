...
class WC_Sohojpaybd_Gateway extends WC_Payment_Gateway
{
	...
	{
		if (is_checkout()) { 
			wp_enqueue_script('sohojpaybd-public', plugin_dir_url(__FILE__) . 'js/sohojpaybd-public.js', ['jquery'], null, true);
		}
	}
	/**
	...
	public function process_payment($order_id)
	{
		...
		if (isset($data['payment_url'])) {
			...
			wc_add_notice(__('Payment gateway error. Please try again.', 'sohojpaybd'), 'error');
			return array(
				'result' => 'failure'
			);
		}
